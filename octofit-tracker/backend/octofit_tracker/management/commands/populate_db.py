...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create users
        users = [
            UserProfile.objects.create(name='Spider-Man', email='spiderman@marvel.com', team=marvel),
            UserProfile.objects.create(name='Iron Man', email='ironman@marvel.com', team=marvel),
            UserProfile.objects.create(name='Wonder Woman', email='wonderwoman@dc.com', team=dc),
            UserProfile.objects.create(name='Batman', email='batman@dc.com', team=dc),
        ]
